...
const nextConfig = {
  ...
  { source: "/testimonials/:path*", destination: "/reviews/:path*", permanent: true },
  { source: "/bus-rental", destination: "/arenda-avtobusov-v-minske", permanent: true },
  { source: "/bus-rental/:path*", destination: "/arenda-avtobusov-v-minske/:path*", permanent: true },
  { source: "/helpful/transfers", destination: "/helpful/transfery-v-aeroport", permanent: true },
  { source: "/helpful/transfers/:path*", destination: "/helpful/transfery-v-aeroport/:path*", permanent: true },
