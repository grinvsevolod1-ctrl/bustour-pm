...
export const defaultSettings: Record<string, string> = {
  ...
  // Dictionary page (/helpful/dictionary) — via dictionaryDefaultSettings() merge above
  // Memos page (/helpful/memos) — via memosDefaultSettings() merge above
  // Transfers page (/helpful/transfers)
