  ...
  callusBannerSettingsGroup,
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: "ID чата или канала. Пусто — значение TELEGRAM_CHAT_ID из окружения. Не знаете ID: напишите боту /start, нажмите «Перепроверить» в блоке состояния выше и выберите чат кнопкой «Использовать».",
      },
    ],
