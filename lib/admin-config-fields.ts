...
export function searchSectionFields(
  ...
  return [
    ...
    {
      key: `${prefix}.search.heading`,
      label: "Заголовок над карточками туров",
      type: "text",
      defaultValue: "",
      placeholder: "Результаты поиска",
      hint: "Текст заголовка над списком туров. Пусто — покажем «Результаты поиска». Чтобы убрать совсем — используйте переключатель ниже.",
    },
    {
