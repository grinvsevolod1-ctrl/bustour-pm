...
// Sort options were extracted from tours-listing.tsx into this shared module.
const sortOptions = read("lib/tours-listing-utils.ts")

assert.match(listing, /category\s*===\s*["']bus["']/)
assert.match(sortOptions, /value:\s*["']popularity["'],\s*label:\s*["']По популярности["']/)
